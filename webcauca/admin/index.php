...
?>
            ...
            <main class="bg-white-300 flex-1 p-3 overflow-hidden">
                <div>
                <center><B class="chao">CHÀO MỪNG BẠN ĐẾN VỚI TRANG QUẢN LÝ</B></center>
                </div>
                <style>
                    B.chao{
                        font-size: 35px;
                ...
                <div class="bgad">
                    <img class="bgadmin" src="../dist/images/bgadmin.png">
                </div>
                <!--Chỉnh img của background index-->
                <style>
                    img.bgadmin{
                        max-width: 160vh;
                        height: 85vh;
